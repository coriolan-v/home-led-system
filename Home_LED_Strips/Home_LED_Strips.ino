...
for(int i = 0; i<NUMPIXELS_FRONT+3; i++){
     ...
     pixels_side.setPixelColor(NUMPIXELS_FRONT-i, pixels_back.Color(255, 0, 0));
     pixels_side.setPixelColor(NUMPIXELS_FRONT-i-1, pixels_back.Color(255, 0, 0));
     pixels_side.setPixelColor(NUMPIXELS_FRONT-i+2, pixels_back.Color(0, 0, 0));
     pixels_side.show();  
  ...
  for(int i = 0; i<NUMPIXELS_FRONT+3; i++){
     ...
     //pixels_front.setPixelColor(NUMPIXELS_FRONT-i-1, pixels_front.Color(255, 0, 0));
     pixels_front.setPixelColor(i-1, pixels_front.Color(0, 0, 0));
     pixels_front.show();   

     pixels_back.setPixelColor(i, pixels_back.Color(255, 0, 0));
     //pixels_back.setPixelColor(NUMPIXELS_FRONT-i-1, pixels_back.Color(255, 0, 0));
     pixels_back.setPixelColor(i-1, pixels_back.Color(0, 0, 0));
     pixels_back.show();   

     pixels_side.setPixelColor(i, pixels_back.Color(255, 0, 0));
     //pixels_side.setPixelColor(NUMPIXELS_FRONT-i-1, pixels_back.Color(255, 0, 0));
     pixels_side.setPixelColor(i-1, pixels_back.Color(0, 0, 0));
     pixels_side.show();  
